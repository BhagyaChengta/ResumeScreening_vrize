...
NER_MODEL = spacy.load(r"C:\Users\HP\Downloads\Deployment\models\ner-model") #load the best model
#with open('models/xgboost_model/xgb_model.pkl', 'rb') as handle:
    #XGB_MODE = pickle.load(handle)
XGB_MODEL = load_pkl(r"C:\Users\HP\Downloads\Deployment\models\xgboost_model\xgb_model.pkl")
#with open('./your_model.pkl', 'rb') as f:
bst = pickle.load(XGB_MODEL)
model = bst.load_model('XGB_MODEL')
TOP_300_SKILLS = load_pkl(r"C:\Users\HP\Downloads\Deployment\models\top_300_skills.pkl")
#with open('models/top_300_skills.pkl', 'rb') as handles:
    #TOP_300_SKILLS = pickle.load(handles)
JD_SKILLS = load_pkl(r"C:\Users\HP\Downloads\Deployment\models\jd_skills.pkl")
#with open('models/jd_skills.pkl', 'rb') as hand:
    #JD_SKILLS = pickle.load(hand)
